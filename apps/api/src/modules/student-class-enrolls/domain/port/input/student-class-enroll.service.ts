...
import { ISubjectPrerequisiteRepository } from 'src/modules/subject-prerequisites/domain/port/output/ISubjectPrerequisiteRepository';
import { IStudentClassResultRepository } from 'src/modules/student-class-results/domain/port/output/IStudentClassResultRepository';
import { ISemesterRepository } from 'src/modules/semesters/domain/port/output/ISemesterRepository';
