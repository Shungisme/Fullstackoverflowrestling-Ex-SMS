                    ...
                    {studentId && classCode ? (
                        <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-md">
                            <p className="font-medium">
                                Xem kết quả của sinh viên có MSSV: {studentId} trong lớp:{" "}
                                {classCode}
                            </p>
                        </div>
                    ) : studentId ? (
                        <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-md">
                            <p className="font-medium">
                                Xem kết quả của sinh viên có MSSV: {studentId}
                            </p>
                        </div>
                    ) : classCode ? (
                        <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-md">
                            <p className="font-medium">Xem kết quả của lớp: {classCode}</p>
                        </div>
                    ) : null}
