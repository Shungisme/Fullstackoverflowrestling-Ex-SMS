...
import { StudentList } from "@/src/types";
  ...
  return (
    <>
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <div className="flex items-center w-full md:w-1/3 gap-4">
          ...
          >
            <SelectTrigger className="w-[20rem]">
              <SelectValue placeholder={t("searchSelectPlaceholder")} />
            </SelectTrigger>
            <SelectContent>
              <SelectItem value="all">{t("selectAllPlaceholder")}</SelectItem>
        ...
        <Button onClick={onAddClick}>{t("tabAddStudent")}</Button>
      </div>
