        ...
        <Tabs defaultValue={defaultTab} className="w-full">
          ...
          <TabsContent value="enroll" className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h2 className="text-xl font-semibold mb-4">Đăng ký khóa học cho sinh viên</h2>
                <p className="text-muted-foreground mb-6">
                  Hoàn thành mẫu bên cạnh để đăng ký khóa học cho sinh viên. Hệ thống sẽ tự động kiểm tra 
                  các điều kiện tiên quyết và số lượng cho phép trong mỗi lớp học.
                </p>
                <div className="bg-muted p-4 rounded-md mb-4">
                  <h3 className="font-medium mb-2">Lưu ý khi đăng ký:</h3>
                  <ul className="list-disc list-inside space-y-1 text-sm">
                    <li>Sinh viên phải đáp ứng tất cả các điều kiện tiên quyết</li>
                    <li>Mỗi lớp học có giới hạn số lượng sinh viên tối đa</li>
                    <li>Sinh viên chỉ được đăng ký các khóa học trong cùng học kỳ</li>
                  </ul>
                </div>
              </div>
          ...
          <TabsContent value="transcript">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h2 className="text-xl font-semibold mb-4">In bảng điểm chính thức</h2>
                <p className="text-muted-foreground mb-6">
                  Tạo và in bảng điểm chính thức cho sinh viên. Bảng điểm sẽ bao gồm 
                  thông tin sinh viên, danh sách môn học, điểm số và điểm trung bình.
                </p>
                <div className="bg-muted p-4 rounded-md mb-4">
