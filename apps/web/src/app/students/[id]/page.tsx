...
export default function StudentDetailPage({
    ...
    const createNewAddress = async () => {
        ...
        try {
            const response = await fetch(
                `${BASE_URL}/students/${params.id}/address/${isAddingAddress}`,
                {
    ...
    const updateAddress = async () => {
        ...
        try {
            const response = await fetch(
                `${BASE_URL}/students/${params.id}/address/${editingAddress.type}`,
                {
                    method: "PATCH",
                    headers: {
                        "Content-Type": "application/json",
    ...
    return (
        <div className="container mx-auto py-8 px-4">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
                ...
                <Badge
                    className={`text-xs py-1 px-3 ${getStatusColor(student.status)}`}
                >
                    {student.status}
                </Badge>
            </div>
                            ...
                            <div className="grid gap-6 md:grid-cols-2">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <Badge
                                            className={`w-fit ${getStatusColor(student.status)}`}
                                        >
                                            {student.status}
                                        </Badge>
                                    </div>
